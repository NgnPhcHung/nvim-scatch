require("obsidian").setup({
  workspaces = {
    {
        name = "PhucHungVaults",
        path = "/Users/nguyenphuchung/library/Mobile Documents/iCloud~md~obsidian/Documents/PhucHungVaults",
      },
  },
  notes_subdir = "inbox",
...
vim.keymap.set("n", "<leader>ok", ":!mv '%:p' /Users/nguyenphuchung/library/Mobile\\ Documents/iCloud~md~obsidian/Documents/PhucHungVaults/phuchungtemp<cr>:bd<cr>")
