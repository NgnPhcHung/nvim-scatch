return function()
	require("noice").setup({
		...
		routes = {
			...
			{ filter = { event = "notify", find = "server does not support" }, opts = { skip = true } },
			{ filter = { event = "notify", find = "textDocument/definition" }, opts = { skip = true } },
			{ filter = { event = "notify", find = "FileType detected" }, opts = { skip = true } },
			{ filter = { event = "notify", find = "TypeScript server" }, opts = { skip = true } },
			{ filter = { event = "msg_show", find = "%d+L, %d+B" }, opts = { skip = true } },
			{ filter = { event = "msg_show", kind = "list_cmd" }, opts = { skip = true } },
